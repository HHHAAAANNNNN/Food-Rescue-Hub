          ...
          <div class="step-card">
            ...
            <div class="step-content">
              ...
              <div class="step-tags">
                ...
                <span class="tag">Categorization</span>
              </div>
            </div>
          </div>
          <div class="step-arrow">
...
.step-card:hover ~ .step-arrow {
  ...
  transform: translateX(-50%) rotate(90deg) translateY(12px) scale(1.1);
